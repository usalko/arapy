...
void MetricStats::toPrometheus(const IResearchDataStore::Stats& data,
                               bool first, size_t index, std::string& result,
  ...
  switch (index) {
    case 0:
      writeMetric(arangodb_search_num_docs::kName, "Number of documents",
                  data.numDocs);
      break;
    case 1:
      writeMetric(arangodb_search_num_live_docs::kName,
                  "Number of live documents", data.numLiveDocs);
      break;
    case 2:
      ...
      break;
    case 3:
      writeMetric(arangodb_search_num_files::kName, "Number of files",
                  data.numFiles);
      break;
    case 4:
      writeMetric(arangodb_search_index_size::kName,
                  "Size of the index in bytes", data.indexSize);
      break;
    default:
      TRI_ASSERT(false);
  }
