...
/// 1426: ERROR_REPLICATION_REPLICATED_STATE_FACTORY_NOT_FOUND
/// "replicated state factory not found"
/// Will be raised when a replicated state factory was not found. This is
/// usually an internal error, warranting a bug report.
#define TRI_ERROR_REPLICATION_REPLICATED_STATE_FACTORY_NOT_FOUND          (::ErrorCode{1426})
